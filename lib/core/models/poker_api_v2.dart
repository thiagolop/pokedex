...
class PokerAPIv2 {
  ...
  PokerAPIv2({this.abilities, this.baseExperience, this.height, this.name, this.sprites, this.stats, this.weight});
...
class GenerationIv {
  ...
  GenerationIv.fromJson(Map<String, dynamic> json) {
    ...
    heartgoldSoulsilver = json['heartgold-soulsilver'] != null ? DiamondPearl.fromJson(json['heartgold-soulsilver']) : null;
...
class DiamondPearl {
  ...
  DiamondPearl(
      {this.backDefault, this.backFemale, this.backShiny, this.backShinyFemale, this.frontDefault, this.frontFemale, this.frontShiny, this.frontShinyFemale});
...
class GenerationVi {
  ...
  GenerationVi.fromJson(Map<String, dynamic> json) {
    omegarubyAlphasapphire = json['omegaruby-alphasapphire'] != null ? Home.fromJson(json['omegaruby-alphasapphire']) : null;
